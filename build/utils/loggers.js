...
loggers.add('infoLogger', {
    transports: [
        new transports.Console({
            level: 'info',
            format: combine(colorize({ all: true, colors: { info: 'blue' } }), timestamp({ format: 'YYYY-MM-DD HH:mm:ss' }), printf((info) => {
                var _a;
                const { timestamp, level, message, ...args } = info;
                const { meta } = args;
                return `${timestamp} ${level}: ${message} Status Code: ${((_a = meta === null || meta === void 0 ? void 0 : meta.res) === null || _a === void 0 ? void 0 : _a.statusCode) || ''} Duration: ${(meta === null || meta === void 0 ? void 0 : meta.responseTime) || ''}`;
            })),
        }),
    ],
});
